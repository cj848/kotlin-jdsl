...
At least Java 8 and Kotlin 2.2 are required to build and run an application with Kotlin JDSL.
...
```kotlin
dependencies {
    implementation("com.linecorp.kotlin-jdsl:jpql-dsl:3.10.0-SNAPSHOT")
    implementation("com.linecorp.kotlin-jdsl:jpql-render:3.10.0-SNAPSHOT")
}
```
